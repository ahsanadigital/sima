...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <a href="{{ route('events.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i><span class="d-none d-md-none d-lg inline">Add New</span></a>
</div>
...
<div class="row justify-content-center">
  <div class="col-md-5 text-center">
    ...
    <h3>Looks Like Empty?</h3>
    <p>Let's add some great event for your friend in one college.</p>

    <a href="{{ route('events.create') }}" class="btn btn-primary"><i class="fas fa-plus mr-2"></i><span>Create New</span></a>
  </div>
</div>
@else
<div class="row">
